...
function checkTest() {
    ...
    const explanations = {
        q1: "To'g'ri javob: went (go fe'lining 2-shakli)",
        q2: "To'g'ri javob: didn't (o'tgan zamonda inkor uchun)",
        q3: "To'g'ri javob: Did (o'tgan zamonda so'roq uchun)",
        q4: "To'g'ri javob: played (play fe'lining 2-shakli)",
        q5: "To'g'ri javob: didn't (o'tgan zamonda inkor uchun)"
    };
